    ...
    <div className="space-y-8">
      ...
      <section className="glass-card p-6 sm:p-8">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          By accessing or using MiniOS Web, you agree to be bound by these Terms of Service.
      ...
      <section className="glass-card p-6 sm:p-8">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
          MiniOS Web is designed for educational purposes to help users understand operating
      ...
      <section className="glass-card p-6 sm:p-8">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          MiniOS Web is open-source software released under the MIT License. You are free to
